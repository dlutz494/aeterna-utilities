    ...
    <DefaultLayout header="Encounters">
        <div class="grid place-items-center">
            ...
            <table class="w-2/3 bg-white text-sm my-4">
                ...
                <tr>
                    <th class="border text-center p-4">Title</th>
                    <th class="border text-start p-4">Description</th>
                    <th class="border text-center p-4">Context</th>
                    <th class="border text-center p-4">Weight</th>
                    <th class="border text-center p-4 italic font-normal">Actions</th>
                </tr>
                </thead>
                <tbody>
                <tr v-for="encounter in encounters" class="odd:bg-stone-100">
                    <td class="border text-center px-4 py-2">{{ encounter.title }}</td>
                    <td class="border text-start w-1/2 px-4 py-2">{{ encounter.description }}</td>
                    <td class="border text-center px-4 py-2">
                        {{ encounter.context ? encounter.context.title : 'N/A' }}
                    </td>
                    <td class="border text-center px-4 py-2">{{ encounter.weight }}</td>
                    <td class="border text-center px-4 py-2">
                        <Link
                            class="rounded-sm p-1 mx-1 text-white bg-stone-600 hover:bg-stone-500 active:bg-stone-700"
                        ...
                        <Link
                            class="rounded-sm p-1 mx-1 text-white bg-red-600 hover:bg-red-500 active:bg-red-700"

...
<template>
    <table class="mb-4 border border-slate-500">
        ...
        <tr v-for="encounter in encounters" class="even:bg-slate-300 dark:even:bg-slate-800">
            <td class="dark:text-white px-2 w-1/6 border border-slate-500">{{ encounter.weight }}</td>
